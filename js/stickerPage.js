...
const cardTemplate = function(todo) {
	var done = todo.done? 'done':''
	var title = todo.title
	var deadline = todo.deadline
	var id = todo.id
...
const detailTemplate = function(todo) {
	var done = todo.done? 'done':''
	var title = todo.title
	var time = todo.date
	var message = todo.message
...
const changeDetail = function(todo) {
...
const limit = function(num, low, high) {
	if( num <= low) {
		num = low
	} else if (num >= high) {
		num = high
...
const moveTriangle = function(id = null) {
...
const bindListAnimation = function() {
	var listWindow = e('#id-list-window')
